...
ifeq ($(DOWMAP), 1)
	...
	ln -sf $(COSMOPMC)/par_files/cosmo.par Demo
	ln -sf $(COSMOPMC)/par_files/cosmo_SN.par Demo
	ln -sf $(COSMOPMC)/par_files/cosmoDP.par Demo
	ln -sf $(COSMOPMC)/par_files/cosmo_lens.par Demo
	ln -sf $(COSMOPMC)/par_files/halomodel.par Demo
	ln -sf $(COSMOPMC)/par_files/cosmo_3rd.par Demo
